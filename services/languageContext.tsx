...
const translations = {
  en: {
    ...
    'emergency.sosSentDesc': 'SOS alert has been successfully sent to your emergency contacts. Please remain calm and composed as assistance is being arranged.',
    ...
    'emergency.tapToSendSOS': 'Tap or Hold to send SOS',
    'emergency.pressAndHold': 'or triple shake to activate',
    'emergency.tapToCancel': 'Tap to cancel',
    'emergency.sosCountdownMessage': 'After 5 seconds, SOS alert and location will be sent to your primary contacts',
    'emergency.sosAlerts': 'SOS Alerts',
    'emergency.sosAlertsDescription': 'Emergency alerts sent to you by your contacts',
    'emergency.noSosAlerts': 'No SOS alerts received.',
    'emergency.noSosAlertsDesc': 'Emergency alerts from your contacts will appear here.',
    'emergency.loadingSosAlerts': 'Loading SOS alerts...',
    'emergency.newSosAlertReceived': 'New SOS Alert Received!',
    'emergency.sosAlertDetails': 'SOS Alert Details',
    ...
    'emergency.whatIsSosAlertDesc': 'The SOS Alert feature allows you to quickly send emergency notifications to your trusted contacts when you feel unsafe or need immediate assistance. When triggered, your location is automatically sent to the police and the alert is tagged as immediate priority. You should expect a phone call from the police to verify your SOS trigger.',
    'emergency.howToUse': 'How to Use',
    'emergency.howToUseDesc': '• Tap the red SOS button to send an alert\n• Press and hold the button for immediate activation\n• The alert will be sent to your primary emergency contacts\n• Your location will be shared with the alert',
    'emergency.whenToUse': 'When to Use',
    'emergency.whenToUseDesc': '• Walking alone at night\n• Feeling threatened or unsafe\n• Medical emergencies\n• Any situation requiring immediate help',
    'emergency.importantNotes': 'Important Notes',
    'emergency.importantNotesDesc': '• Only use for real emergencies\n• Make sure you have emergency contacts set up\n• Keep your location services enabled\n• Test the feature in a safe environment first',
    ...
    'emergency.tapSOSButton': '1. Tap SOS Button',
    'emergency.tapSOSButtonDesc': 'Simply tap the red SOS button to start a 5-second countdown before sending the alert.',
    'emergency.tripleShakeFeature': '2. Triple Shake Feature',
    'emergency.tripleShakeFeatureDesc': 'Shake your device three times quickly to trigger the SOS countdown. You can turn this feature off in the app settings. Make sure to use enough force for the device to detect the motion.',
    'emergency.longPressFeature': '3. Long Press',
    'emergency.longPressFeatureDesc': 'Press and hold the SOS button for immediate activation without countdown.',
    'emergency.tripleShakeDetails': 'Triple Shake Feature Details',
    'emergency.tripleShakeDetailsDesc': '• The triple shake feature uses your device\'s accelerometer to detect rapid shaking motions\n• You need to shake your device three times in quick succession\n• This feature works even when the app is minimized or in the background\n• You can disable this feature in your device settings if needed\n• Make sure to shake with enough force for the device to detect the motion',
  ...
  fil: {
    ...
    'emergency.tapToSendSOS': 'I-tap o Hawakan para mag-send ng SOS',
    'emergency.pressAndHold': 'o tatlong beses yugyugin para ma-activate',
    'emergency.tapToCancel': 'I-tap para kanselahin',
    'emergency.sosCountdownMessage': 'Pagkatapos ng 5 segundo, ang SOS alert at lokasyon ay ma-se-send sa inyong mga primary contacts',
    'emergency.sosAlerts': 'Mga SOS Alert',
    'emergency.sosAlertsDescription': 'Mga emergency alert na ipinadala sa inyo ng inyong mga contact',
    'emergency.noSosAlerts': 'Walang natanggap na SOS alert.',
    'emergency.noSosAlertsDesc': 'Ang mga emergency alert mula sa inyong mga contact ay lalabas dito.',
    'emergency.loadingSosAlerts': 'Naglo-load ng SOS alerts...',
    'emergency.newSosAlertReceived': 'May Bagong SOS Alert na Natanggap!',
    'emergency.sosAlertDetails': 'Mga Detalye ng SOS Alert',
    ...
    'emergency.whatIsSosAlertDesc': 'Ang SOS Alert feature ay nagbibigay-daan sa inyo na mabilis na magpadala ng emergency notifications sa inyong mga pinagkakatiwalaang contact kapag pakiramdam ninyo ay hindi ligtas o kailangan ninyo ng agarang tulong. Kapag na-trigger, ang inyong lokasyon ay awtomatikong ipapadala sa pulisya at ang alert ay ma-tag bilang immediate priority. Dapat ninyong asahan ang tawag mula sa pulisya upang i-verify ang inyong SOS trigger.',
    'emergency.howToUse': 'Paano Gamitin',
    'emergency.howToUseDesc': '• I-tap ang pulang SOS button para magpadala ng alert\n• Yugyugin ang telepono tatlong beses para sa agarang activation\n• Ang alert ay ma-se-send sa inyong mga primary emergency contacts\n• Ang inyong lokasyon ay ma-share kasama ng alert',
    'emergency.whenToUse': 'Kailan Gamitin',
    'emergency.whenToUseDesc': '• Paglalakad mag-isa sa gabi\n• Pakiramdam ay nanganganib o hindi ligtas\n• Medical emergencies\n• Anumang sitwasyon na nangangailangan ng agarang tulong',
    'emergency.importantNotes': 'Mahalagang Paalala',
    'emergency.importantNotesDesc': '• Gamitin lang para sa tunay na emergency\n• Siguraduhing may naka-setup na emergency contacts\n• Panatilihing naka-enable ang inyong location services\n• I-test ang feature sa ligtas na environment muna',
    ...
    'emergency.tapSOSButton': '1. I-tap ang SOS Button',
    'emergency.tapSOSButtonDesc': 'I-tap lang ang pulang SOS button para mag-start ng 5-second countdown bago i-send ang alert.',
    'emergency.tripleShakeFeature': '2. Triple Shake Feature',
    'emergency.tripleShakeFeatureDesc': 'I-shake ang inyong device ng tatlong beses nang mabilis para ma-trigger ang SOS countdown. Maaari ninyong i-off ang feature na ito sa app settings. Siguraduhing gamitin ang sapat na lakas para ma-detect ng device ang motion.',
    'emergency.longPressFeature': '3. Long Press',
    'emergency.longPressFeatureDesc': 'Pindutin at hawakan ang SOS button para sa immediate activation na walang countdown.',
    'emergency.tripleShakeDetails': 'Mga Detalye ng Triple Shake Feature',
    'emergency.tripleShakeDetailsDesc': '• Ginagamit ng triple shake feature ang accelerometer ng inyong device para ma-detect ang mabilis na shaking motions\n• Kailangan ninyong i-shake ang inyong device ng tatlong beses nang sunud-sunod\n• Gumagana ang feature na ito kahit naka-minimize ang app o nasa background\n• Puwede ninyong i-disable ang feature na ito sa device settings kung kailangan\n• Siguraduhing i-shake nang may sapat na lakas para ma-detect ng device ang motion',
