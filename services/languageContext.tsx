...
const translations = {
  en: {
    ...
    'emergency.tapToSendSOS': 'Tap to send SOS',
    'emergency.pressAndHold': '(or press and hold)',
  ...
  fil: {
    ...
    'emergency.tapToSendSOS': 'I-tap para mag-send ng SOS',
    'emergency.pressAndHold': '(o pindutin nang matagal)',
