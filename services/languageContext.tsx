...
const translations = {
  en: {
    ...
    'emergency.tripleShakeFeatureDesc': 'Shake your device three times quickly to trigger the SOS countdown. This feature works even when the app is in the background.',
  ...
  fil: {
    ...
    'emergency.tripleShakeFeature': '2. Triple Shake Feature',
    'emergency.tripleShakeFeatureDesc': 'I-shake ang inyong device ng tatlong beses nang mabilis para ma-trigger ang SOS countdown. Gumagana ang feature na ito kahit nasa background ang app.',
    'emergency.longPressFeature': '3. Long Press',
